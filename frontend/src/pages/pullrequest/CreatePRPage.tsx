        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 w-full lg:w-3/5">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-5 shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-400 text-xs mb-2 uppercase tracking-wider font-bold">Source Branch</label>
                  <select
                    value={sourceBranch}
                    onChange={(e) => setSourceBranch(e.target.value)}
                    className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-gray-300 text-sm focus:outline-none focus:border-blue-500 transition-all font-medium"
                  >
                ...
                <div>
                  <label className="block text-gray-400 text-xs mb-2 uppercase tracking-wider font-bold">Target Branch</label>
                  <select
                    value={targetBranch}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:border-blue-500 placeholder-gray-600 transition-all"
                />
              </div>

              {/* Description */}
              <div>
                <label className="block text-gray-400 text-xs mb-2 uppercase tracking-wider font-bold">Description</label>
                <textarea
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  placeholder="Describe the changes in this PR..."
                  rows={6}
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:border-blue-500 placeholder-gray-600 resize-none transition-all"
                />
              </div>
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex-1 bg-gray-800 hover:bg-gray-700 text-gray-300 text-sm font-bold py-3 rounded-lg transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-bold py-3 rounded-lg transition-all shadow-lg shadow-blue-900/20"
                >
          ...
          <div className="flex-1 w-full lg:w-2/5">
            <div className="sticky top-8">
              <CompareLanding 
                branches={branches} 
                onSelectBranch={(name: string) => navigate(`/${username}/${reponame}/compare/main...${name}`)}
              />
            </div>
          </div>
        </div>
