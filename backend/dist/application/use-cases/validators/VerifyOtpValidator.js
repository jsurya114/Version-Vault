...
exports.VerifyOtpValidator = void 0;
...
let VerifyOtpValidator = class VerifyOtpValidator {
    userRepo;
    otpService;
    constructor(userRepo, otpService) {
    ...
    async validate(dto) {
        ...
        if (!isValidOtp)
            throw new ValidationError_1.ValidationError('Not a Valid Otp or Otp expired');
    }
};
exports.VerifyOtpValidator = VerifyOtpValidator;
exports.VerifyOtpValidator = VerifyOtpValidator = __decorate([
