...
export const LogoIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <div className={`rounded-full bg-blue-600 flex items-center justify-center text-white shrink-0 shadow-sm ${className}`}>
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-[55%] h-[55%]">
      <path d="M7 6l5 10 5-10" />
    ...
    <nav className="border-b border-gray-800 px-4 sm:px-6 py-3 flex flex-col sticky top-0 bg-gray-950/95 backdrop-blur z-50">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-3 sm:gap-4 min-w-0">
          <Link to={ROUTES.HOME} className="flex items-center gap-2.5 shrink-0 group hover:opacity-80 transition-opacity">
            <LogoIcon className="w-8 h-8" />
            <span className="font-bold text-white text-base hidden sm:inline tracking-tight">
              VersionVault
            </span>
          </Link>
