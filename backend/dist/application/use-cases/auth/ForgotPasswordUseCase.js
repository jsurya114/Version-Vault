...
let ForgotPasswordUseCase = class ForgotPasswordUseCase {
    ...
    userRepo;
    otpService;
    constructor(emailService, userRepo, otpService) {
...
exports.ForgotPasswordUseCase = ForgotPasswordUseCase = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)(tokens_1.TOKENS.IEmailService)),
    __param(1, (0, tsyringe_1.inject)(tokens_1.TOKENS.IUserRepository)),
    __param(2, (0, tsyringe_1.inject)(tokens_1.TOKENS.IOtpService)),
