...
let ResendOtpUseCase = class ResendOtpUseCase {
    ...
    emailService;
    _logger;
    constructor(userRepo, otpService, emailService, _logger) {
    ...
    async execute(email) {
        ...
        if (user.isVerified)
            throw new ValidationError_1.ValidationError('Account is already verified');
...
exports.ResendOtpUseCase = ResendOtpUseCase = __decorate([
    ...
    __param(3, (0, tsyringe_1.inject)(tokens_1.TOKENS.ILogger)),
