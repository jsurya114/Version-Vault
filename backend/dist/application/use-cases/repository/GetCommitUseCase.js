...
exports.GetCommitUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const GitService_1 = require("../../../infrastructure/services/GitService");
let GetCommitUseCase = class GetCommitUseCase {
    gitService;
    constructor(gitService) {
        this.gitService = gitService;
    }
    async execute(ownerUsername, repoName, branch = 'main', limit = 20) {
        return this.gitService.getCommits(ownerUsername, repoName, branch, limit);
    }
};
exports.GetCommitUseCase = GetCommitUseCase;
exports.GetCommitUseCase = GetCommitUseCase = __decorate([
