...
let GetPRUseCase = class GetPRUseCase {
    _prRepository;
    constructor(_prRepository) {
...
exports.GetPRUseCase = GetPRUseCase;
exports.GetPRUseCase = GetPRUseCase = __decorate([
