        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-sm max-w-lg mx-auto">
              Everything from small startups to tech giants trust VersionVault to keep things
              moving.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Protect your code at every step. VersionVault automatically scans for errors and
              alerts you to vulnerabilities in your dependencies before they become problems.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-blue-600 rounded-2xl px-10 py-14 text-center">
          ...
          <p className="text-blue-100 text-sm mb-8 max-w-md mx-auto">
            Join over 90 million developers who are already using VersionVault to build amazing
