          ...
          <div className="flex items-center gap-3 xs:gap-4 mb-6">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-full font-semibold uppercase ${planColors[selectedUser.subscriptionPlan.toLowerCase()] || planColors.free}`}
                >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 xs:p-5 sm:p-6">
                ...
                <div className="mb-5 pt-4 border-t border-gray-800">
                  ...
                  <div
                    className={`bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm capitalize flex items-center justify-between ${selectedUser.subscriptionPlan.toLowerCase() === 'pro' ? 'text-indigo-400 font-bold' : 'text-white'}`}
                  >
                    <span>{selectedUser.subscriptionPlan} Plan</span>
                    {selectedUser.subscriptionPlan.toLowerCase() === 'pro' && (
                      <svg
