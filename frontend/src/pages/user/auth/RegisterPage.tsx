...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center px-4 py-10">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-5/12 bg-gray-950 p-10 flex flex-col justify-center gap-8">
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              <h1 className="text-2xl font-bold text-white">Join VersionVault</h1>
              <p className="text-gray-400 text-sm leading-relaxed">
                Start managing your repositories and version history with enterprise-grade security
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Military-grade encryption and access controls',
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Seamless workflow for distributed teams',
                },
              ].map((f) => (
                <div
                  key={f.title}
          ...
          <div className="md:w-7/12 p-10 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              >
                {isLoading ? 'Creating account...' : 'Create your VersionVault account'}
              </button>
            </form>
      ...
      {/* Bottom sign-in card */}
      <div className="w-full max-w-4xl mt-4 bg-gray-900 border border-gray-800 rounded-2xl py-4 text-center">
