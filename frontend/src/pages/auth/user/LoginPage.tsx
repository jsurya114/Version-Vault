...
import { selectAuthError,selectAuthLoading,selectIsAuthenticated } from "src/features/auth/authSelectors";
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-5/12 bg-gray-950 p-10 flex flex-col justify-center gap-8">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={f.title} className="bg-gray-900 border border-gray-800 rounded-xl px-4 py-3">
          ...
          <div className="md:w-7/12 p-10 flex flex-col justify-center">
            ...
            <p className="text-center text-gray-500 text-xs mt-4">
              New to VersionVault?{' '}
              <Link to={ROUTES.REGISTER} className="text-blue-400 hover:text-blue-300 transition font-medium">
                Create an account,
              </Link>
