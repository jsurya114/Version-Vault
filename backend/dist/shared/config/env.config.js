...
exports.envConfig = {
    ...
    GOOGLE_CALLBACK_URL: process.env.GOOGLE_CALLBACK_URL || 'http://localhost:3125/vv/auth/google/callback',
    ...
    RATE_LIMIT_WINDOW_MS: Math.min(parseInt(process.env.RATE_LIMIT_WINDOW_MS || '900000', 10), 2147483647),
    RATE_LIMIT_MAX_REQUESTS: parseInt(process.env.RATE_LIMIT_MAX_REQUESTS || '100', 10),
    GROQ_API_KEY: process.env.GROQ_API_KEY,
    STRIPE_SECRET_KEY: process.env.STRIPE_SECRET_KEY || '',
    STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET || '',
    STRIPE_PRO_PRICE_ID: process.env.STRIPE_PRO_PRICE_ID || '',
    CLIENT_SUBSCRIPTION_SUCCESS_URL: process.env.CLIENT_SUBSCRIPTION_SUCCESS_URL ||
        `${process.env.CLIENT_URL || 'http://localhost:5173'}/subscription?status=success`,
    CLIENT_SUBSCRIPTION_CANCEL_URL: process.env.CLIENT_SUBSCRIPTION_CANCEL_URL ||
