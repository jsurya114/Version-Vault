...
import { selectAdminUsers, selectAdminLoading, selectAdminError } from 'src/features/admin/adminSelectors';
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="border-b border-gray-800 px-6 py-3 flex items-center justify-between">
          <div className="relative">
            ...
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 text-xs border border-gray-700 rounded px-1">⌘K</span>
          </div>
        ...
        <main className="flex-1 p-6 overflow-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Manage platform access, roles, and repository permissions for all users.</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <button className="bg-gray-900 border border-gray-800 rounded-lg px-4 py-2 text-sm text-gray-300 hover:bg-gray-800 transition">Filter</button>
            <button className="bg-gray-900 border border-gray-800 rounded-lg px-4 py-2 text-sm text-gray-300 hover:bg-gray-800 transition">Sort</button>
          </div>
          ...
          {!isLoading && !error && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
              <table className="w-full">
                ...
                <tbody>
                  {filtered.map((u) => {
                    ...
                    return (
                      <tr key={u.id} className="border-b border-gray-800/50 last:border-0 hover:bg-gray-800/30 transition">
                        ...
                        <td className="px-4 py-3">
                          <span className={`text-xs px-2 py-0.5 rounded font-medium ${roleColors[u.role] || 'bg-gray-700 text-gray-400'}`}>
                            {u.role}
                          </span>
                        </td>
              ...
              <div className="border-t border-gray-800 px-4 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button className="text-gray-400 hover:text-white text-sm px-3 py-1 rounded border border-gray-700 hover:bg-gray-800 transition">Previous</button>
                  <button className="text-gray-400 hover:text-white text-sm px-3 py-1 rounded border border-gray-700 hover:bg-gray-800 transition">Next</button>
                </div>
              </div>
            </div>
          )}
