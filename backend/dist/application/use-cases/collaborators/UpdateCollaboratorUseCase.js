...
let UpdateCollaboratorUseCase = class UpdateCollaboratorUseCase {
    _collabRepo;
    constructor(_collabRepo) {
        this._collabRepo = _collabRepo;
    }
    async execute(ownerId, repositoryId, collaboratorId, role) {
        ...
        if (!updated) {
            throw new NotFoundError_1.NotFoundError('Failed to update collaborator role');
        }
        return updated;
    }
};
exports.UpdateCollaboratorUseCase = UpdateCollaboratorUseCase;
exports.UpdateCollaboratorUseCase = UpdateCollaboratorUseCase = __decorate([
