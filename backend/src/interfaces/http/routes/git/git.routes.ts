...
router.get('/:username/:reponame(*)/info/refs', (req: Request, res: Response) =>
...
router.post('/:username/:reponame(*)/git-upload-pack', (req: Request, res: Response) =>
  handleGitRequest(req, res),
);
...
router.post('/:username/:reponame(*)/git-receive-pack', (req: Request, res: Response) =>
  handleGitRequest(req, res),
);
