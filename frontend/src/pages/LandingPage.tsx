  ...
  <nav className="border-b border-gray-800 px-4 sm:px-8 py-3 flex items-center justify-between sticky top-0 bg-gray-950/95 backdrop-blur z-50">
    <div className="flex items-center gap-4 sm:gap-8">
      <div className="flex items-center gap-2 group cursor-pointer hover:opacity-80 transition-opacity">
        ...
        <span className="font-bold text-white text-sm sm:text-base tracking-tight">VersionVault</span>
      </div>
  ...
  <footer className="border-t border-gray-800 py-10 px-4 sm:px-8">
    <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8">
      <div className="col-span-2 md:col-span-1">
        <div className="flex items-center gap-2 mb-4 group cursor-pointer hover:opacity-80 transition-opacity">
          <LogoIcon className="w-7 h-7" />
          <span className="font-bold text-white text-base tracking-tight">VersionVault</span>
        </div>
