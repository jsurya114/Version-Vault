    ...
    <BrowserRouter>
      <ErrorBoundary>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            {/* user */}
           <Route path={ROUTES.LANDING} element={<PublicRoute><LandingPage /></PublicRoute>} />
          <Route path={ROUTES.LOGIN} element={<PublicRoute><LoginPage /></PublicRoute>} />
          <Route path={ROUTES.REGISTER} element={<PublicRoute><RegisterPage /></PublicRoute>} />
          <Route path={ROUTES.VERIFY_OTP} element={<PublicRoute><OtpVerificationPage /></PublicRoute>} />
          <Route path={ROUTES.GOOGLE_CALLBACK} element={<GoogleCallBackpage />} />

          <Route path={ROUTES.HOME} element={<ProtectRoute requiredRole='user'><HomePage /></ProtectRoute>} />

            {/* admin */}
            <Route path={ROUTES.ADMIN_LOGIN} element={<AdminLoginPage />} />
            {/* Protected admin routes */}
          <Route path={ROUTES.ADMIN_DASHBOARD} element={<ProtectRoute requiredRole='admin'><AdminDashboard /></ProtectRoute>} />
          <Route path={ROUTES.ADMIN_USERS} element={<ProtectRoute requiredRole='admin'><AdminUsersPage /></ProtectRoute>} />
